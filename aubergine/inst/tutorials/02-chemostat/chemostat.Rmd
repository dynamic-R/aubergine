...
```{r, single, , fig.height=3, fig.width=10}
...
```{r, steadystate, fig.height=3, fig.width=10}
state <- data.frame(
...
plot(Alg     ~ D, data = state, type = "l")
plot(S * Alg ~ D, data = state, type = "l")
```
...
```{r analytical, fig.height=3, fig.width=10}
