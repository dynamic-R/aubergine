...
```{r npz-scenario-exercise, exercise = TRUE, exercise.lines = 20, exercise.setup="chemostat-npz-code", fig.height=3, fig.width=8}
times <- seq(0, 1000)
parms["d"] <- 0.0
...
```{r npz-scenario0, fig.height=3, fig.width=8, exercise.setup="chemostat-npz-code"}
times <- seq(0, 1000)
parms["d"] <- 0.0
out0 <- ode(y, times, npz, parms)
plot(out0, mfrow = c(1, 3))
...
```{r npz-scenario1, fig.height=3, fig.width=8, exercise.setup="chemostat-npz-code"}
parms["d"] <- 0.2
