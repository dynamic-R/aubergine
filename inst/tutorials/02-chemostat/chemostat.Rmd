...
The equations governing the dynamics of **N** and **P** are:
$$
...
$c_{pn}$ is the stoichiometric conversion factor to go from nutrient P (phosphorus) to phytoplankton C (i.e. the molar P:C ratio).
