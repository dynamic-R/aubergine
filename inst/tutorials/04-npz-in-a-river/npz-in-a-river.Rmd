...
```{r river-np, fig.height=4, fig.width=8}
...
```{r riverNPZ, exercise=TRUE, exercise.lines=30, fig.height=4, fig.width=8}
library(ReacTran)           
...
```{r riverNPZ-solution, fig.height=4, fig.width=8}
library(ReacTran)
...
The model function is repeated first:
```{r, fig.height=5, fig.width=8}
<<riverNPZ-solution>>
```

Flow rates are varied from 1 km /day up to 10 km per day:

```{r riverNPZscenario, fig.height=8, fig.width=8}
